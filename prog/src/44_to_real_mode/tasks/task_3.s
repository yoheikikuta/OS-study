task_3:
    ...
    ; Initialization
    ;-----------------------
    mov    esi, 0x0010_7000  ; ESI = (draw parameter)
...
.t3:
    istruc rose
        at rose.x0, dd 32  ; left top X0
        at rose.y0, dd 32  ; left top Y0
        at rose.x1, dd 208  ; right bottom X1
        at rose.y1, dd 208  ; right bottom Y1
...
.t4:
    istruc rose
        at rose.x0, dd 248  ; left top X0
        at rose.y0, dd 32   ; left top Y0
        at rose.x1, dd 424  ; right bottom X1
        at rose.y1, dd 208  ; right bottom Y1
        ...
        at rose.color_y, dd 0x0007  ; color Y axis
        at rose.color_z, dd 0x000F  ; color frame
        at rose.color_s, dd 0x040F  ; color character
        at rose.color_f, dd 0x000F  ; color graph drawing
        at rose.color_b, dd 0x0004  ; color graph erasing
...
.t5:
    istruc rose
        at rose.x0, dd 32   ; left top X0
        at rose.y0, dd 272  ; left top Y0
        at rose.x1, dd 208  ; right bottom X1
        at rose.y1, dd 448  ; right bottom Y1
        ...
        at rose.color_y, dd 0x0007  ; color Y axis
        at rose.color_z, dd 0x000F  ; color frame
        at rose.color_s, dd 0x050F  ; color character
        at rose.color_f, dd 0x000F  ; color graph drawing
        at rose.color_b, dd 0x0005  ; color graph erasing
...
.t6:
    istruc rose
        ...
        at rose.color_y, dd 0x0007  ; color Y axis
        at rose.color_z, dd 0x000F  ; color frame
        at rose.color_s, dd 0x060F  ; color character
        at rose.color_f, dd 0x000F  ; color graph drawing
        at rose.color_b, dd 0x0006  ; color graph erasing
